...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/books',
            ...
            const args = {
                    correlationId: {"in":"header","name":"Corelation-Id","required":true,"dataType":"string"},
                    ...
                    optionalId: {"in":"header","name":"Optional-Id","dataType":"string"},
            };
        ...
        app.get('/health/readiness',
            ...
            function UsersController_getReadiness(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getReadiness.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/health/liveness',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.getLiveness)),

            function UsersController_getLiveness(request: any, response: any, next: any) {
            const args = {
            };
